...
app.use(
  cors({
    origin: ['*','https://movielist-cookie-auth-frontend.vercel.app','https://movielist-cookie-auth-frontend.vercel.app/'],// React uygulamanızın çalıştığı adres
...
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "*"); // React uygulamanızın adresi
